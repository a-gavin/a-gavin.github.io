...
{{ image(src="/blog/2023-10-wifi-packet-capture/80211_lan_topology.png", align="center", caption="802.11 LAN Topology", alt="802.11 LAN Topology") }}
...
{{ image(src="/blog/2023-10-wifi-packet-capture/wireshark_selecting_interface.png", align="center", caption="Selecting Wireless monitor 'moni0'", alt="Image of selecting wireless interface to perform packet capture on") }}

{{ image(src="/blog/2023-10-wifi-packet-capture/wireshark_pcap_in_progress.png", align="center", caption="Packet capture in progress using 'moni0'", alt="Image of packet capture in progress using interface 'moni0'") }}
...
{{ image(src="/blog/2023-10-wifi-packet-capture/wireshark_4way_handshake.png", align="center", caption="EAPOL four-way handshake", alt="Image of Wireshark capture showing a four-way handshake") }}
